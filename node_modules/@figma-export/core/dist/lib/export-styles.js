...
exports.styles = ({ token, fileId, outputters = [], log = (msg) => {
    // eslint-disable-next-line no-console
    console.log(msg);
}, }) => __awaiter(void 0, void 0, void 0, function* () {
    const client = figma_1.getClient(token);
    log('fetching styles');
    const styleNodes = yield figmaStyles_1.fetchStyles(client, fileId);
    log('parsing styles');
    const parsedStyles = yield figmaStyles_1.parseStyles(styleNodes);
